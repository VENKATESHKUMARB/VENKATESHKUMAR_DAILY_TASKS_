...
public class empty_password{
    ...
    @Test
    public void testRegisterWithEmpty_PasswordField() throws InterruptedException {
        ...
        System.out.println("TestCase Role : Password Field is Empty");
       ...
       System.out.print("My Empty_passwordfield TestCase is Successfully Executed");
