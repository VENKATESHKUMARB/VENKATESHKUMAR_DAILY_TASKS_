...
public class emptydob_field{
    ...
    @Test
    public void testRegisterWithEmpty_DOBField() throws InterruptedException {
        ...
        emailField.sendKeys("bvkr1311200@gmail.com");
      ...
      System.out.println("TestCase Role : DOB Field is Empty");
        ...
        System.out.println("My TestCase is Successfully Executed");
