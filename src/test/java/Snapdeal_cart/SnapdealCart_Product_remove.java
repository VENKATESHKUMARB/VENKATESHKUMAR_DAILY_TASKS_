...
public class SnapdealCart_Product_remove {
	...
	@Test (groups= "product_remove",description="Verify the remove the Products From the Cart")
	public void removeCart() throws InterruptedException {
		try {
			...
			Reporter.log("Enter the values on the Searchbar (eg,Shoes)",true);
			...
			Reporter.log("Click the Add to Cart",true);
			...
			viewcart.click();
			 ...
			 Reporter.log("Click the Viewcart",true);
			...
			remove_cart.click();
			 ...
			 Reporter.log("Click the remove products",true);
		...
		Reporter.log("Verify the  Remove Products form the Cart",true);
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\test_removeCart.png\">ProductRemove_Click</a>");
