...
public class SnapdealCart_page {
    ...
    @Test(groups= "cartpage",description="Verify the CartPage are Visible")
    public void cart_Item() throws InterruptedException {
        try {
            ...
            Reporter.log("Enter the values on the Searchbar (eg,fasttrack)",true);
            ...
            Reporter.log("Click the Particular products",true);
        ...
        Reporter.log("Verify the  Products in a Cart",true);
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\testcart_Item.png\">Snapdealcart_Click</a>");
