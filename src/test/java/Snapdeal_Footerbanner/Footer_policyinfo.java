...
WebDriver driver;
    ...
    @Test(priority = 1,groups= {"Policyinfo"},description="Verify the Policyinfo is Displayed")
    public void footer_policyinfo() {
        ...
        try {
            ...
            Reporter.log("Find the 'Policy info', in Footer",true);
        ...
        Reporter.log("Verify the  Footer in 'Policy info' is visible.",true);
    ...
    @Test(priority = 2,groups= "Policyinfo" ,description="Verify the Policyinfo list are Visible")
    public void Footer_policyList() {
    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
        Actions actions = new Actions(driver);
        ...
        //  "Terms of Sale"  to be Hover
            ...
            Reporter.log("Verify the  Footer in 'Terms of Sale' is visible.",true);
        ...
        //  "Terms of use"  to be Hover
            ...
            Reporter.log("Verify the  Footer in 'Terms of use' is visible.",true);
        ...
        //  "Takedown Policy"  to be Hover
            ...
            Reporter.log("Verify the  Footer in 'Takedown Policy' is visible.",true);
            ...
            Reporter.log("Verify the  Footer in 'BIS Standard Policy' is visible.",true);
        ...
        //  " BIS Certification Policy"  to be Hover
            ...
            Reporter.log("Verify the  Footer in 'Products Under Cumpulsory BIS Certification' is visible.",true);
            ...
            Reporter.log("Verify the  Footer in 'FAQ' is visible.",true);
...
Reporter.log("Verify the  Footer policy Info List");
        ...
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\testFooter_policyList.png\">FooterPolicy_click</a>");
