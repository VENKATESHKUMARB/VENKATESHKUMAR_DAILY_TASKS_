...
public class Snapdeal_rigister {
    ...
    @Test(groups = "register",description="Verify the Register Functionality ")    
    public void RegisterWithEmptyEmailField() {
        try {
            ...
            Reporter.log("Hover on the 'Sign In' button ",true);
            ...
            Reporter.log("Click on the 'Register' button ",true);
            ...
            Reporter.log("Click on the 'mobileNumberField' enter the Mobile Number ",true);
            ...
            Reporter.log("Click on the 'Continue' button ",true);
            ...
            Reporter.log("Click on the 'emailField' empty space ",true);
            ...
            Reporter.log("Click on the 'nameField' enter the enter the Name ",true);
            ...
            Reporter.log("Click on the 'passwordField' enter the enter the Password ",true);
 ...
 Reporter.log("Verify the Error message for empty email field is empty",true);
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\testRegisterWithEmptyEmailField.png\">Register_Click</a>");
...
//  ScreenShots
  ...
  @AfterMethod (groups="functional_login")
