...
public class Snapdeal_login {
    ...
    @Test (groups= "functional_login",description="Verify the Login Functionality ")
    public void Login() {
        ...
        try {
            ...
            Reporter.log("Hover over the 'Sign In' button ",true);
            ...
            Reporter.log("Click  the 'usernameField' enter the values ",true);
            ...
            Reporter.log("Click  the 'Continue' button ",true);
            ...
            Reporter.log("Click  the 'otpField' enter the values ",true);
        ...
        Reporter.log("Verify the  Login page is displayed.",true);
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\test_Login.png\">Login_Click</a>");
