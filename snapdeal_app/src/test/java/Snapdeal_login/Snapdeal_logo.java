...
public class Snapdeal_logo {
    ...
    Assert.assertTrue(snapdealLogo.isDisplayed(), "The Snapdeal logo is not visible on the website.");
        ...
        Reporter.log("Verify the  Snapdeal_brand Logo's are displayed.");
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\testLogoVisibility.png\">click</a>");
