...
public class products_detail_page {
    ...
    public void testProduct_details() {
        ...
        Reporter.log("Verify the Products are Visible");
    ...
    public void testProductDetailPage() {
        ...
        Reporter.log("Verify the Products Detail Page");
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\testProductDetailPage.png\">click</a>");
