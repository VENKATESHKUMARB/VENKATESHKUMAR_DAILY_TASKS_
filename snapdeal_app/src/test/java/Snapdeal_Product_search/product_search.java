...
public class product_search {
   ...
   private static final Logger logger = LoggerFactory.getLogger(product_search.class);
    ...
    public void searchValidProduct() {
        ...
        Reporter.log("Verify the  InValid product search results are displayed.");
    ...
    public void searchInvalidProduct() {
        ...
        Reporter.log("Verify the  Valid product search results are displayed.");
        
        Reporter.log("<a href= \"C:\\Users\\venkatesh.baskaran\\eclipse-workspace\\snapdeal_app\\Screenshots\\searchInvalidProduct.png\">click</a>");
