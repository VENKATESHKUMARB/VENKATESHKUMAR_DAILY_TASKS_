...
public class empty_name{
    ...
    @Test(groups= {""})
    public void testRegister_NameEmpty() throws InterruptedException {
        ...
        mobileNumberField.sendKeys("8778227125");
        ...
        System.out.println("TestCase Role : Name field is Empty");  
    ...
    System.out.println("My Empty_namefield Testcase is Successfully executed");    
