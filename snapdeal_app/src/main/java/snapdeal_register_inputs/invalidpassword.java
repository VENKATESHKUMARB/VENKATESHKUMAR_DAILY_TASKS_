...
public class invalidpassword {
    ...
    @Test
    public void testRegisterWithInvalid_password() throws InterruptedException {
        ...
        emailField.sendKeys("bvkr13112001@gmail.com");
        
        WebElement nameField = driver.findElement(By.xpath("(//input[@id='j_name'])[1]"));
        nameField.sendKeys("badri");
        
        System.out.println("Testcase role : InvalidPassword");
        
        WebElement dobField = driver.findElement(By.xpath("(//input[@id='j_dob'])[1]"));
        dobField.sendKeys("24/08/2007");
        
        WebElement passwordField = driver.findElement(By.xpath("(//input[@id='j_password'])[1]"));
        passwordField.sendKeys("badri");
        ...
        System.out.println("My Invalid Password TestCase is Successfully Executed");
